...
from BackModels import SimpleRNN, RRN, NARM, STAMP, DUPN, Transformer
...
class PredictModel(nn.Module):
    def __init__(self,
        ...
        if model in ['LSTM', 'TimeLSTM', 'Motivate']:
            ...
            self.rnn = Transformer(input_dim, hidden_dim, dropout_rate, 4)
    ...
    def forward(self, x, label_len):
        ...
        h = self.rnn(x, label_len)  # (bs,label_length,hidden_dim)
